...
@protocol Ule_ScannerDelegate <NSObject>
 ...
 *  摄像头枚举
 */
typedef NS_ENUM(NSUInteger, UleCamera){
    /**
     *  背面摄像头
     */
    UleCameraBack,
...
@interface Ule_Scanner : NSObject
/**
 *  YES 正在读取
 */
 ...
 *  YES 既是使用前置摄像头
 */
@property (nonatomic, assign) UleCamera camera;
 ...
 * delegate
 */
@property (nonatomic, assign) id <Ule_ScannerDelegate> delegate;
/**
 *  初始化扫描器
 *
